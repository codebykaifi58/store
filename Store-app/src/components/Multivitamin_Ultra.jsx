...
import pre_pic_2 from '../assets/multivitamin_ultra-.1.webp';
import halal from '../assets/Halal-Good-Logo-300x160-1-300x160.jpg';

const Multivitamin_Ultra = () => {
...
const productName = "Multivitamin Ultra - 60 Capsules";
          ...
          <div className="col mt-4" id='whey-protien-detail-back'>
            ...
            <div id="whey-details-few" className='mt-5'>
              ...
              <p style={{ fontWeight: '500' }}>
                Performance Multivitamin is a blend of the finest vitamins and minerals to support the body’s 
                immunity and overall well-being. Performance Multivitamin is specifically designed for anyone 
                who has an active lifestyle or trains to a high level of intensity on a regular basis.
              </p>
            </div>
          ...
          <div className="col mt-5">
            ...
            <div id="whey-protien-form-back">
              <div className="variation-form p-4 border rounded shadow-sm mt-4">
                <h5 className="mb-3">Product: 60 Capsules</h5>
...
export default Multivitamin_Ultra;
