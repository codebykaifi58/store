...
import pre_pic_2 from '../assets/ZM-Bottle-1080-by-1080-1-600x599.jpg';
import halal from '../assets/Halal-Good-Logo-300x160-1-300x160.jpg';

const Zinc_And_Magnesium = () => {
...
const productName = "Zinc And Magnesium (Ultimate Testosterone Booster) – 180 Capsules";
        ...
        <div className="row" id='whey-protien-row1'>
          ...
          <div className="col mt-4" id='whey-protien-detail-back'>
            <div id="whey-heading-back">
              <h3>Zinc And Magnesium (Ultimate Testosterone Booster)</h3>
            </div>
            ...
            <div id="whey-details-few" className='mt-5'>
              ...
              <p style={{ fontWeight: '500' }}>
                The Protein Factory is pleased to announce that we have become authorized sellers of Pure Health Nutrition.
                 Pure Health Nutrition is Pakistan’s first high quality sports nutrition brand. PHN’s aim is to provide its
                  customers with the best quality supplements at the best prices. All the ingredients are imported from the
                   best suppliers around the world. Only the  packaging is done in Pakistan. 
              </p>
            </div>

            <div id="whey-advantages-back">
              <ul>
                <li>Builds and supports testosterone levels.</li>
                ...
                <li>Improves bone and teeth health.</li>
              </ul>
            </div>
          </div>
        </div>
          ...
          <div className="col mt-5">
            ...
            <div id="whey-protien-form-back">
              <div className="variation-form p-4 border rounded shadow-sm mt-4">
                <h5 className="mb-3">Product: 180 Capsules</h5>
...
export default Zinc_And_Magnesium;
