...
const productName = "Nitroboost Extreme Preworkout – Extreme Pump! - 90 Capsules ";
        ...
        <div className="row" id='whey-protien-row1'>
              ...
              <div className="row">
                <div className="col-lg-6 mx-auto" id='gallery-back'>
                  <div className="featured-image mb-3">
                    <img src={pre_pic_2} alt="Featured" className="img-fluid" />
                  </div>
          ...
          <div className="col mt-4" id='whey-protien-detail-back'>
            <div id="whey-heading-back">
              <h3>Nitroboost Extreme Preworkout – Extreme Pump!</h3>
            </div>
            ...
            <div id="whey-details-few" className='mt-5'>
              ...
              <p style={{ fontWeight: '500' }}>
                The Protein Factory is pleased to announce that we have become authorized sellers of Pure Health Nutrition.
                 Pure Health Nutrition is Pakistan’s first high quality sports nutrition brand. PHN’s aim is to provide 
                 its customers with the best quality supplements at the best prices. All the ingredients are imported 
                 from the best suppliers around the world. Only the  packaging is done in Pakistan. 
              </p>
            </div>

            <div id="whey-advantages-back">
              <ul>
                <li>Most advanced Preworkout Tablets in Pakistan</li>
                <li>Gives an Extreme Pump</li>
          ...
          <div className="col mt-5">
            ...
            <div id="whey-protien-form-back">
              <div className="variation-form p-4 border rounded shadow-sm mt-4">
                <h5 className="mb-3">Product: 90 Capsules</h5>
