...
import pre_pic_2 from '../assets/Thermopro-600x600.jpg';
...
const productName = "Thermopro (Fat Destroyer) Mega Sale! - 45 Capsules";
        ...
        <div className="row" id='whey-protien-row1'>
          ...
          <div className="col mt-4" id='whey-protien-detail-back'>
            <div id="whey-heading-back">
              <h3>Thermopro (Fat Destroyer) Mega Sale!</h3>
            </div>
            ...
            <div id="whey-details-few" className='mt-5'>
              ...
              <p style={{ fontWeight: '500' }}>
                Note:Thermopro is a potent performance formula in a convenient capsule format. It is popular as a pre-workout supplement, designed to optimise performance by reducing tiredness and fatigue, supporting energy production and mental performance.
              </p>
            </div>
          ...
          <div className="col mt-5">
            ...
            <div id="whey-protien-form-back">
              <div className="variation-form p-4 border rounded shadow-sm mt-4">
                <h5 className="mb-3">Product: 45 Capsules</h5>
