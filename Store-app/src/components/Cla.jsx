...
import pre_pic_2 from '../assets/cla_60_softgels.1-1-600x600.jpg';
...
const Cla = () => {
  ...
  const unitPrice = 3149.00;

  const handleIncrement = () => setQuantity(prev => prev + 1);
  const handleDecrement = () => setQuantity(prev => (prev > 1 ? prev - 1 : 1));


const productName = "CLA (FOR A LEAN AND SHREDDED BODY) - 60 Capsules";
const addToCart = () => {
        ...
        <div className="row" id='whey-protien-row1'>
          ...
          <div className="col mt-4" id='whey-protien-detail-back'>
            <div id="whey-heading-back">
              <h3>CLA (FOR A LEAN AND SHREDDED BODY)</h3>
            </div>
            ...
            <div id="whey-details-few" className='mt-5'>
              ...
              <p style={{ fontWeight: '500' }}>
                Note:CLA otherwise known as Conjugated Linoleic Acid is a premium source of highly concentrated CLA,
                 derived naturally from safflowers. TPW™ CLA softgels are made to the highest possible standards to
