...
const variants = [
  { id: 1, flavor: 'Chocolate', weight: '1 kg', price: 7999 },
  { id: 2, flavor: 'Chocolate', weight: '2 kg', price: 14999 },
  { id: 3, flavor: 'Unflavoured', weight: '1 kg', price: 7999 },
  { id: 4, flavor: 'Unflavoured', weight: '2 kg', price: 14999 },
  { id: 5, flavor: 'Cafe Latte Coffee (Best Tasting)', weight: '1 kg', price: 7999 },
  { id: 6, flavor: 'Cafe Latte Coffee (Best Tasting)', weight: '2 kg', price: 14999 },
];
...
const productName = "Pea Protein Isolate by Pure Health Nutrition – MEGA SALE!";
  const addToCart = () => {
                    ...
                    <div className="row" id='whey-protien-row1'>
                        ...
                        <div className="col mt-4" id='whey-protien-detail-back'>
                            <div id="whey-heading-back">
                                <h3>
                                    Pea Protein Isolate by Pure Health Nutrition – MEGA SALE!
                                </h3>
                            </div>
                            <div id="whey-details-few" className='mt-5'>
                                ...
                                <p style={{fontWeight:'500'}}>
                                    Note:The Protein Factory is pleased to announce that we have become authorized sellers of
                                     Pure Health Nutrition. Pure Health Nutrition is Pakistan’s first high quality sports 
                                     nutrition brand. PHN’s aim is to provide its customers with the best quality supplements
                                      at the best prices. All the ingredients are imported from the best suppliers around the
                                       world. Only the  packaging is done in Pakistan. 
                                </p>
                            </div>
...
export default Pea_protien_isolate;
